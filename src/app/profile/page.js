...
export default function ProfilePage() {
  ...
  // Helper to show "Not set yet" when viewing                                                                                                                                                                
  const display = (value) => (value ? value : "Not set yet");
  if (loading) {
    return (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    type="text"
                    name="name"
                    value={isEditing ? (formData.name || "") : display(profile.name)}
                    onChange={handleChange}
                    disabled={!isEditing}
                    placeholder={isEditing ? "Enter your full name" : undefined}
                ...
                <div>
                  ...
                  <input
                    ...
                    value={isEditing ? (formData.studentWhatsapp || "") : display(profile.studentWhatsapp)}
                    onChange={handleChange}
                    disabled={!isEditing}
                    placeholder={isEditing ? "+91 98765 43210" : undefined}
                    className={`w-full px-5 py-4 rounded-xl border text-base ${
                      isEditing
                        ? "border-gray-300 bg-white focus:border-[#3C88A7] focus:ring-4 focus:ring-[#3C88A7]/20"
                        : "border-gray-200 bg-gray-50 text-gray-500 italic"
                ...
                <div>
                  ...
                  <input
                    type="text"
                    name="parentWhatsapp"
                    value={isEditing ? (formData.parentWhatsapp || "") : display(profile.parentWhatsapp)}
                    onChange={handleChange}
                    disabled={!isEditing}
                    placeholder={isEditing ? "+91 98765 00000" : undefined}
                    className={`w-full px-5 py-4 rounded-xl border text-base ${
                      isEditing
                        ? "border-gray-300 bg-white focus:border-[#3C88A7] focus:ring-4 focus:ring-[#3C88A7]/20"
                        : "border-gray-200 bg-gray-50 text-gray-500 italic"
                ...
                <div>
                  ...
                  <input
                    type="text"
                    name="schoolName"
                    value={isEditing ? (formData.schoolName || "") : display(profile.schoolName)}
                    onChange={handleChange}
                    disabled={!isEditing}
                    placeholder={isEditing ? "Your school name" : undefined}
                    className={`w-full px-5 py-4 rounded-xl border text-base ${
                      isEditing
                        ? "border-gray-300 bg-white focus:border-[#3C88A7] focus:ring-4 focus:ring-[#3C88A7]/20"
                        : "border-gray-200 bg-gray-50 text-gray-500 italic"
                ...
                <div>
                  ...
                  <select
                    name="board"
                    value={isEditing ? (formData.board || "") : (profile.board || "")}
                    onChange={handleChange}
                    disabled={!isEditing}
                    className={`w-full px-5 py-4 rounded-xl border text-base ${
                      isEditing
                  ...
                  >
                    <option value="" disabled>
                      {isEditing ? "Select Board" : "Not set yet"}
                    </option>
                ...
                <div>
                  ...
                  <select
                    name="class"
                    value={isEditing ? (formData.class || "") : (profile.class || "")}
                    onChange={handleChange}
                    disabled={!isEditing}
                    className={`w-full px-5 py-4 rounded-xl border text-base ${
                      isEditing
                  ...
                  >
                    <option value="" disabled>
                      {isEditing ? "Select Class" : "Not set yet"}
                    </option>
